...
document.getElementById("add-word-form").classList.add("editing-form");
document.getElementById("edit-status").style.display = "block";

// When exiting edit mode (after update)
document.getElementById("add-word-form").classList.remove("editing-form");
